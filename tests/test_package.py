...
Run with coverage: pytest --cov=aa_si_visualization
"""

import aa_si_visualization


def test_version_exists():
    """Test that the package has a version string."""
    assert hasattr(aa_si_visualization, "__version__")
    assert isinstance(aa_si_visualization.__version__, str)


def test_version_format():
    """Test that version follows semantic versioning format (X.Y.Z)."""
    version = aa_si_visualization.__version__
...
#     result = plot_sv_echogram(input_value)
